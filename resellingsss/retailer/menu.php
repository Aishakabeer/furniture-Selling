...
<div class="page-wrap">
    <div class="ps-section--hero"><img src="images/hero/11.jpg" alt="">
        <div class="ps-section__content text-center">
            <h3 class="ps-section__title">Reselling Products</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                        <header class="text-center">
                            ...
                            <h4>Saree salwar suit kurtha.</h4>
    ...
    <div class="modal-popup mfp-with-anim mfp-hide" id="quickview-modal" tabindex="-1">
        ...
        <div class="ps-product-modal ps-product--detail clearfix">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 ">
                <header>
                    <h3 class="ps-product__name">Anytime salwar</h3>
