...
<body>
    <div id="containerDiv">
        ...
        <!-- Footer Section -->
        <div id="footerDiv" style="background-color: #333; color: white; text-align: center; padding: 20px 0; margin-top: 40px;">
            <div id="footerContent">
                <h3>Contact Us</h3>
                <p>Email: <a href="mailto:info@furnitureshop.com" style="color: #fff;">info@furnitureshop.com</a></p>
                <p>Address: 1234 Main St, Furniture Town, FT 56789</p>
                <p>Phone: (123) 456-7890</p>
                <p>Opening Hours: Mon-Fri: 9 AM - 6 PM | Sat: 10 AM - 4 PM | Sun: Closed</p>
            </div>
        </div>
    </div>
</body>
